...
router
    .route('/')
    .get(verifyJWT, verifyRoles([ROLES_LIST.Admin, ROLES_LIST.Editor, ROLES_LIST.User]), getUser)
    .patch(
        verifyJWT,
...
router.route('/all').get(verifyJWT, verifyRoles([ROLES_LIST.Admin, ROLES_LIST.Editor]), getAllUser);
